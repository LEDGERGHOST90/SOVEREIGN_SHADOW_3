...
class OptimalColdStorageSystem:
    ...
    def _load_capital_tracker(self) -> Dict:
        ...
        # Initialize with starting capital from portfolio_config
        cb_init = get_initial_capital('coinbase')
        okx_init = get_initial_capital('okx')
        kr_init = get_initial_capital('kraken')
        return {
            'coinbase': {'initial': cb_init, 'withdrawn': 0, 'last_balance': cb_init},
            'okx': {'initial': okx_init, 'withdrawn': 0, 'last_balance': okx_init},
            'kraken': {'initial': kr_init, 'withdrawn': 0, 'last_balance': kr_init},
        }
