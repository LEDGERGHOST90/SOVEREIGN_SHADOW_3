...
class ProfitTracker:
    ...
    def __init__(self):
        ...
        # Load initial capital from centralized config (portfolio_config.py)
        self.initial_capital = {
            'coinbase': get_initial_capital('coinbase'),
            'okx': get_initial_capital('okx'),
            'kraken': get_initial_capital('kraken'),
            'binance_us': get_initial_capital('binance_us'),
        }
