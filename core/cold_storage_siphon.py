    ...
    def _initialize_exchanges(self) -> Dict[str, ccxt.Exchange]:
        ...
        try:
            exchanges['okx'] = ccxt.okx({
                ...
                'secret': os.getenv('OKX_API_SECRET'),  # Fixed: was OKX_SECRET_KEY
                'password': os.getenv('OKX_API_PASSPHRASE'),  # Fixed: was OKX_PASSPHRASE
                'enableRateLimit': True,
            })
            print("✅ OKX connected")
        except Exception as e:
        ...
        try:
            exchanges['kraken'] = ccxt.kraken({
                ...
                'secret': os.getenv('KRAKEN_API_SECRET'),  # Fixed: was KRAKEN_PRIVATE_KEY
                'enableRateLimit': True,
            })
