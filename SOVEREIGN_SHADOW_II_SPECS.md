...
```yaml
portfolio:
  total_value: $7,855.05
  hot_wallet: $1,660.00 (Coinbase)
  binance_us: $152.05
  cold_storage: $6,167.43 (Ledger)
  aave_collateral: $3,494.76
  aave_debt: $1,158.58

trading_requirements:
  minimum_capital: $1,000
...
### 6. AAVE SDK
```yaml
sdk: web3.py + AAVE Protocol
version: v3
purpose: DeFi lending position monitoring
contract: Ethereum mainnet
features:
  - Collateral tracking ($3,494.76)
  - Debt monitoring ($1,158.58)
  - Health factor calculation
  - Liquidation alerts
status: ⚠️ Requires web3 module
monitoring:
  collateral: $3,494.76
  debt: $1,158.58
