...
from core import SovereignOrchestrator
...
async def main():
    """Main entry point"""
    logger.info("=" * 60)
    logger.info("SOVEREIGN II - AUTONOMOUS TRADING SYSTEM")
    logger.info("=" * 60)
    ...
    try:
        ...
        logger.info("Sovereign II shutdown complete")
